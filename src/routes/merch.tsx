    ...
    <div className="min-h-screen bg-black text-white font-tight overflow-x-hidden">
      ...
      <div className="pt-[160px] sm:pt-[200px] lg:pt-[240px] px-4 lg:px-12">
        ...
        <p className="mt-6 sm:mt-10 max-w-[560px] text-sm sm:text-base lg:text-lg text-white/70 leading-snug">
          Hoodies, tees, and caps built from the AXIS archive. First drop ships when the agent hits
          $10M in managed positions. Join the waitlist — earliest signups get the drop before it
          goes public.
        </p>
        ...
        >
          ...
          >
            {joined ? (
              <>
                <Check size={16} strokeWidth={2.25} /> On the list
              </>
            ) : (
              "Join waitlist"
            )}
      ...
      <div className="mt-24 sm:mt-40 px-4 lg:px-12 pb-[160px] sm:pb-[220px]">
        <div className="flex items-center justify-between mb-6 sm:mb-10">
          <div className="text-white/50 text-[10px] sm:text-xs uppercase tracking-[0.2em]">
            Preview / v1 pieces
          </div>
