...
const STEPS = [
  {
    ...
    k: "01",
    t: "Sign in",
    d: "Google auth. Magic mints a wallet. You never see a seed phrase.",
  },
  {
    icon: Shield,
    k: "02",
    t: "Upgrade",
    d: "EIP-7702 upgrades your EOA. Same address, agent-capable.",
  },
  {
    icon: Sparkles,
    k: "03",
    t: "Intent",
    d: "State a goal. AXIS translates it into a multi-chain execution plan.",
  },
  {
    icon: Zap,
    k: "04",
    ...
    <div className="min-h-screen bg-black text-white font-tight overflow-x-hidden">
      ...
      <div className="px-4 lg:px-12 mt-20 sm:mt-32 lg:mt-40 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/10 border border-white/10">
        {STEPS.map(({ icon: Icon, k, t, d }) => (
          <div
            key={k}
            className="bg-black p-6 sm:p-8 lg:p-12 min-h-[220px] sm:min-h-[280px] flex flex-col justify-between"
          >
            <div className="grid grid-cols-[auto_minmax(0,1fr)] items-start gap-3">
              <Icon size={32} strokeWidth={1.5} />
              <span className="text-[10px] uppercase tracking-widest text-white/50 justify-self-end">
                {k}
              </span>
            </div>
            <div className="mt-8 sm:mt-0">
              <div className="text-2xl sm:text-3xl lg:text-4xl uppercase tracking-[-0.04em]">
                {t}
              </div>
      ...
      <div className="mt-24 sm:mt-32 lg:mt-40 pb-[160px] sm:pb-[220px]">
        <div className="px-4 lg:px-12 mb-10 sm:mb-16">
          <div className="text-white/50 text-[10px] sm:text-xs uppercase tracking-[0.2em] mb-3 sm:mb-4">
            Observed / Live capture
          </div>
          <div className="text-2xl sm:text-4xl lg:text-5xl tracking-[-0.03em]">
            The agent runs in the open.
          </div>
        </div>
        <ScatteredGrid
          items={6}
          render={(i) => (
            <div className="w-full h-full bg-white/5 border border-white/10 flex items-center justify-center">
              <div className="text-center px-4">
                ...
                <div className="text-5xl sm:text-6xl lg:text-8xl mt-3 tracking-[-0.05em]">
